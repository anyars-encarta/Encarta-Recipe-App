...
# Inventories
first_inv = Inventory.create(name:'Inventory 1', description:'This inventory description is out of this world', users_id: 1)
second_inv = Inventory.create(name:'Inventory 2', description:'Maybe, this inventory description is out of the water', users_id: 2)
third_inv = Inventory.create(name:'Inventory 3', description:'Yet another inventory description that is out of this planet', users_id: 1)
fourth_inv = Inventory.create(name:'Inventory 4', description:'Which of the inventory description is out of this world', users_id: 2)
fifth_inv = Inventory.create(name:'Inventory 5', description:'Can you handle the inventory description that is out of this world', users_id: 1)
sixth_inv = Inventory.create(name:'Inventory 6', description:'Most times, this inventory description is out of this world', users_id: 1)
seventh_inv = Inventory.create(name:'Inventory 7', description:'I can\'t beleive this inventory description is out of this world', users_id: 2)
eighth_inv = Inventory.create(name:'Inventory 8', description:'Here comes another inventory description that is out of this world', users_id: 1)
nineth_inv = Inventory.create(name:'Inventory 9', description:'Definitely or maybe not, this inventory description is out of this world', users_id: 2)
tenth_inv = Inventory.create(name:'Inventory 10', description:'As I confirmed earlier, this inventory description is out of this world', users_id: 2)
